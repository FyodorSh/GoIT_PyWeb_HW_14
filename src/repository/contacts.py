...
async def create_contact(body: ContactSchema, db: Session, user: User) -> Contact:
    """
    Create contact
...
async def update_contact(body: ContactSchema, contact_id: int, db: Session, user: User) -> Contact:
    """
...
async def search_contacts(query: str, db: Session, user: User) -> List[Contact]:
    """
